...
public class Word2VecUseController {
	...
	public Response obtenerPalabras(@PathParam("id") String id, @PathParam("wid") String wid, @QueryParam("word") String word) {
		
		Word2VecUseService word2VecUseService = new Word2VecUseService();
		
		
		return Response.ok(word2VecUseService.obtenerPalabras(id, wid, word))
